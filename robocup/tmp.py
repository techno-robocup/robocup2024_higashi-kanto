...
_COLORSENSOR_L_G = 0
_COLORSENSOR_L_B = 0
_    if isgreen_L(_COLORSENSOR_L_R, _COLORSENSOR_L_G, _COLORSENSOR_L_B) and isgreen_R(_COLORSENSOR_R_R, _COLORSENSOR_R_G, _COLORSENSOR_R_B):COLORSENSOR_R_R = 0
_COLORSENSOR_R_G = 0
_COLORSENSOR_R_B = 0
...
while True:
    ...
    if isgreen_L(_COLORSENSOR_L_R,_COLORSENSOR_L_G,_COLORSENSOR_L_B) and isgreen_R(_COLORSENSOR_R_R,_COLORSENSOR_R_G,_COLORSENSOR_R_B):
